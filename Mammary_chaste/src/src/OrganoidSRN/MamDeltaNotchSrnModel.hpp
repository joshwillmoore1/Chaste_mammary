#ifndef MAMDELTANOTCHSRNMODEL_HPP_
#define MAMDELTANOTCHSRNMODEL_HPP_
 ...
 */
class MamDeltaNotchSrnModel : public AbstractOdeSrnModel
{
private:
...
protected:
     ...
     */
    MamDeltaNotchSrnModel(const MamDeltaNotchSrnModel& rModel);
...
public:
     ...
     */
    MamDeltaNotchSrnModel(boost::shared_ptr<AbstractCellCycleModelOdeSolver> pOdeSolver = boost::shared_ptr<AbstractCellCycleModelOdeSolver>());
...
#endif /* MAMDELTANOTCHSRNMODEL_HPP_ */
