...
55	     * Set the diffusion constant for the cells.
56	     *
57	     * @param scaleForceParameter the movement parameter to use
58	     */
	    void SetScaleForceParameter(double scaleForceParameter);
	
	    /**
62	     * Get the random motion coefficient.
63	     *
64	     * @return mScaleForceParameter
65	     */
	    double GetScaleForceParameter();
