#ifndef MATURECELLKILLER_HPP_
#define MATURECELLKILLER_HPP_
...
class MatureCellKiller : public AbstractCellKiller<DIM>
{
private:
...
public:
     ...
     */
    MatureCellKiller(AbstractCellPopulation<DIM>* pCellPopulation);
...
inline void save_construct_data(
    Archive & ar, const MatureCellKiller<DIM> * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, MatureCellKiller<DIM> * t, const unsigned int file_version)
{
    ...
    ::new(t)MatureCellKiller<DIM>(p_cell_population);
}
}
} // namespace ...

#endif /*MATURECELLKILLER_HPP_*/
