#ifndef COLLIERTRACKINGMODIFIER_HPP_
#define COLLIERTRACKINGMODIFIER_HPP_
...
class CollierTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
    /** Needed for serialization. */
    double mPolarisationParameter;
...
public:
     ...
     * Default constructor.
     */
    CollierTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~CollierTrackingModifier();

     /**
55	     * Set the polarisation gradient bound constant for the cells.
56	     *
57	     * @param polarisationParameter the movement parameter to use
58	     */
	    void SetPolarisationParameter(double polarisationParameter);
...
65	     */
	    double GetPolarisationParameter();
...
#endif /*COLLIERTRACKINGMODIFIER_HPP_*/
