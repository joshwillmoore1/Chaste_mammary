...
c_vector<double, SPACE_DIM> ApicalBasalDivisionRule<SPACE_DIM>::CalculateCellDivisionVector(
    CellPtr pParentCell,
...
template class ApicalBasalDivisionRule<1>;
template class ApicalBasalDivisionRule<2>;
template class ApicalBasalDivisionRule<3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_SAME_DIMS(ApicalBasalDivisionRule)
