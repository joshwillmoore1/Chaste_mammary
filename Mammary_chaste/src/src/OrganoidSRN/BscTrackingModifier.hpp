#ifndef BSCTRACKINGMODIFIER_HPP_
#define BSCTRACKINGMODIFIER_HPP_
...
class BscTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
#endif /*BSCTRACKINGMODIFIER_HPP_*/
