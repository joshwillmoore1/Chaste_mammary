#ifndef APICALBASALDIVISIONRULE_HPP_
#define APICALBASALDIVISIONRULE_HPP_
...
class ApicalBasalDivisionRule : public AbstractVertexBasedDivisionRule<SPACE_DIM>
{
private:
...
public:
     ...
     * Empty destructor.
     */
    virtual ~ApicalBasalDivisionRule()
    {
    }
