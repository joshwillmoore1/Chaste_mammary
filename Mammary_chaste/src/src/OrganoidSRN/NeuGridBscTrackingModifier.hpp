#ifndef NEUGRIDBSCTRACKINGMODIFIER_HPP_
#define NEUGRIDBSCTRACKINGMODIFIER_HPP_
...
class NeuGridBscTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    NeuGridBscTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~NeuGridBscTrackingModifier();
...
#endif /*NEUGRIDBSCTRACKINGMODIFIER_HPP_*/
