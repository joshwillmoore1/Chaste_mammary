#ifndef MAMNDMADAPTIVETRACKINGMODIFIER_HPP_
#define MAMNDMADAPTIVETRACKINGMODIFIER_HPP_
...
class MamNDMAdaptiveTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    MamNDMAdaptiveTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~MamNDMAdaptiveTrackingModifier();
...
#endif /*MAMNDMADAPTIVETRACKINGMODIFIER_HPP_*/
