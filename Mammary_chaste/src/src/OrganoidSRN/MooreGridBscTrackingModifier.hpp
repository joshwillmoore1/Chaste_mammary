#ifndef MOOREGRIDBSCTRACKINGMODIFIER_HPP_
#define MOOREGRIDBSCTRACKINGMODIFIER_HPP_
...
class MooreGridBscTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    MooreGridBscTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~MooreGridBscTrackingModifier();
...
#endif /*MOOREGRIDBSCTRACKINGMODIFIER_HPP_*/
