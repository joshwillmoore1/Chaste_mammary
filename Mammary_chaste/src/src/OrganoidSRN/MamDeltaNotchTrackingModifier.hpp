#ifndef MAMDELTANOTCHTRACKINGMODIFIER_HPP_
#define MAMDELTANOTCHTRACKINGMODIFIER_HPP_
...
class MamDeltaNotchTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    MamDeltaNotchTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~MamDeltaNotchTrackingModifier();
...
#endif /*MAMDELTANOTCHTRACKINGMODIFIER_HPP_*/
