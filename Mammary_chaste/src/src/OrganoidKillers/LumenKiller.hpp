#ifndef LUMENKILLER_HPP_
#define LUMENKILLER_HPP_
...
class LumenKiller : public AbstractCellKiller<DIM>
{
private:
...
public:
     ...
     */
    LumenKiller(AbstractCellPopulation<DIM>* pCellPopulation);
...
inline void save_construct_data(
    Archive & ar, const LumenKiller<DIM> * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, LumenKiller<DIM> * t, const unsigned int file_version)
{
    ...
    ::new(t)LumenKiller<DIM>(p_cell_population);
}
}
} // namespace ...

#endif /*LUMENKILLER_HPP_*/
