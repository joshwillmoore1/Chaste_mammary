#ifndef SMOOTHVERTEXBOUNDARIES_HPP_
#define SMOOTHVERTEXBOUNDARIES_HPP_
...
class SmoothVertexBoundaries : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    SmoothVertexBoundaries();

    /**
     * Destructor.
     */
    virtual ~SmoothVertexBoundaries();
...
#endif /*SMOOTHVERTEXBOUNDARIES_HPP_*/
