#ifndef BRANCHDIVISIONRULE_HPP_
#define BRANCHDIVISIONRULE_HPP_
...
class BranchDivisionRule : public AbstractVertexBasedDivisionRule<SPACE_DIM>
{
private:
