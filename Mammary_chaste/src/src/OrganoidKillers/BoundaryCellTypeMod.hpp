#ifndef BOUNDARYCELLTYPEMOD_HPP_
#define BOUNDARYCELLTYPEMOD_HPP_
...
class BoundaryCellTypeMod : public AbstractCellKiller<DIM>
{
private:
...
public:
     ...
     */
    BoundaryCellTypeMod(AbstractCellPopulation<DIM>* pCellPopulation);
...
inline void save_construct_data(
    Archive & ar, const BoundaryCellTypeMod<DIM> * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, BoundaryCellTypeMod<DIM> * t, const unsigned int file_version)
{
    ...
    ::new(t)BoundaryCellTypeMod<DIM>(p_cell_population);
}
}
} // namespace ...

#endif /*BOUNDARYCELLTYPEMOD_HPP_*/
