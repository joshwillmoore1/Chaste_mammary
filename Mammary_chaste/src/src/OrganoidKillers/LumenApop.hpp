#ifndef LUMENAPOP_HPP_
#define LUMENAPOP_HPP_
...
class LumenApop : public AbstractCellKiller<DIM>
{
private:
...
public:
     ...
     */
    LumenApop(AbstractCellPopulation<DIM>* pCellPopulation);
...
inline void save_construct_data(
    Archive & ar, const LumenApop<DIM> * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, LumenApop<DIM> * t, const unsigned int file_version)
{
    ...
    ::new(t)LumenApop<DIM>(p_cell_population);
}
}
} // namespace ...

#endif /*LUMENAPOP_HPP_*/
