...
BscTrackingModifier<DIM>::BscTrackingModifier()
...
template<unsigned DIM>
void BscTrackingModifier<DIM>::UpdateAtEndOfTimeStep(AbstractCellPopulation<DIM,DIM>& rCellPopulation)
{
    UpdateCellData(rCellPopulation);
}

template<unsigned DIM>
void BscTrackingModifier<DIM>::SetupSolve(AbstractCellPopulation<DIM,DIM>& rCellPopulation, std::string outputDirectory)
{
    /*
...
template<unsigned DIM>
void BscTrackingModifier<DIM>::UpdateCellData(AbstractCellPopulation<DIM,DIM>& rCellPopulation)
{
...
template<unsigned DIM>
void BscTrackingModifier<DIM>::OutputSimulationModifierParameters(out_stream& rParamsFile)
{
...
template class BscTrackingModifier<1>;
template class BscTrackingModifier<2>;
template class BscTrackingModifier<3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_SAME_DIMS(BscTrackingModifier)